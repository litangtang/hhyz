...
public final class DateUtil {
	...
	public static final String SEPARATOR_STR = "至";
	...
	/**
	 * Date 去掉时分秒，返回yyyy-MM-dd格式的Date
	 * @param date
	 * @return
	 */
	 ...
	 * @return
	 */
	public static String dateConcat(Date start, Date end, String separator) {
		SimpleDateFormat format = new SimpleDateFormat(DATE_FORMAT);
	...
	/**
	 * 给定的日期减一个月 格式为：2009-08
	 */
	public static String subYearMonth(String strdate) {
	...
	public static boolean boolcompara(String startdate, String enddate)
			throws ParseException {
		if (DateFormat.getDateInstance().parse(startdate).compareTo(
				DateFormat.getDateInstance().parse(startdate)) >= 0) {
			return true;
		} else {
			return false;
		}
	...
	public static boolean isDateBefore(Date date2) {
		return Calendar.getInstance().getTime().before(date2);
	}
	 ...
	 * @return
	 */
	public static String getCurrntYear() {
		// 获得当前日期
		Calendar cldCurrent = Calendar.getInstance();
		// 获得年
		String strYear = String.valueOf(cldCurrent.get(Calendar.YEAR));
	 ...
	 * @return
	 */
	public static String getCurrntMon() {
		// 获得当前日期
		Calendar cldCurrent = Calendar.getInstance();
		String strMonth = String.valueOf(cldCurrent.get(Calendar.MONTH) + 1);
		return strMonth;
	 ...
	 * @return
	 */
	public static String getCurrntDay() {
		// 获得当前日期
		Calendar cldCurrent = Calendar.getInstance();
	...
	/**
	 * 取得一个年的List，当前年的前两年-当前年的后两年
	 * @return
	 */
	public static List<String> getAllYearList() {
		List<String> yearList = new ArrayList<String>();
		String currYearStr = StringUtil.trim(DateUtil.getCurrntYear());
		int currYear = Integer.parseInt(currYearStr);
		for(int i=currYear-2; i<=currYear+2; i++) {
			yearList.add(StringUtil.trim(String.valueOf(i)));
		}
	 ...
	 * @return
	 */
	public static List<String> getAllMonList() {
		List<String> monthList = new ArrayList<String>();
		for(int i=1; i<=12; i++) {
			monthList.add(StringUtil.trim(String.valueOf(i)));
		}
		return monthList;
	}
	...
	public static Integer getYearFromDate(Date date) {
		...
		yourCalendar.setTime(date);
		return yourCalendar.get(Calendar.YEAR);
	}
	
	//截取日期中的月
	public static Integer getMonFromDate(Date date) {
		Calendar yourCalendar = Calendar.getInstance();
		yourCalendar.setTime(date);
		return yourCalendar.get(Calendar.MONTH) + 1;
	}
	...
	public static Integer getDayFromDate(Date date) {
		Calendar yourCalendar = Calendar.getInstance();
		yourCalendar.setTime(date);
		return yourCalendar.get(Calendar.DATE);
	}
	 ...
	 * @return
	 */
	public static boolean isCurrDay(Date date) {
		return isCurrDay(DateUtil.dateToStr(date));
	 ...
	 * @return
	 */
	public static boolean isCurrDay(String date) {
	...
	public static String getSeparatorStr() {
