		...
		<table width="186" border="0" align="left" cellpadding="0"
			...
			<tr>
				<td height="40" align="center" valign="middle">
					<a href="client/listAll.action?searchType=1" class="menulink" target="rightFrame"><font color="red">原料客户</font></a>
				</td>
			</tr>
			<tr>
				<td height="40">
					<a href="client/listAll.action?searchType=2" class="menulink" target="rightFrame"><font color="red">销售客户</font></a>
				</td>
			</tr>
