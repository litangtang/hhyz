		...
		<table width="186" border="0" align="left" cellpadding="0"
			...
			<tr>
				<td height="40" align="center" valign="middle">
					<a href="trade/listAll.action?tradeFlag=1" class="menulink" target="rightFrame"><font color="red">原料往来</font></a>
				</td>
			</tr>
			<tr>
				<td height="40">
					<a href="trade/listAll.action?tradeFlag=2" class="menulink" target="rightFrame"><font color="red">销售往来</font></a>
				</td>
			</tr>
			<tr>
				<td height="40">
					<a href="#" class="menulink" target="rightFrame">统计</a>
				</td>
			</tr>
			<tr>
				<td height="40">
