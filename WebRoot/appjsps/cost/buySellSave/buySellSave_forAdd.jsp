	...
	<head>
		...
		$(function() {
			...
			$("#submitBtn").click(function() {
				...
				document.forms[0].action = "buySellSave/add.action";
					...
					<table width="100%" border="0" align="left" cellpadding="0"
						...
						<tr>
							...
							<td background="img/main02.png">
								<span id="maintop"></span><span class="mainAction">当前路径：增加一条进销存记录</span>
							</td>
							...
							<td align="center" valign="top" bgcolor="#FEFCFC" height="500">
								...
								<table class="maintable" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
										<tr>
											...
											<td>
												<input type="text" id="date" name="buySellSave.date"
										...
										<tr>
											...
											<td>
												<input type="text" id="buyAmount" name="buySellSave.buyAmount"  class="ui-widget-content ui-corner-all"/>&nbsp;&nbsp;kg
											</td>
											<td><span id="star">*</span></td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" id="buyPrice" name="buySellSave.buyPrice" class="ui-widget-content ui-corner-all"/>&nbsp;&nbsp;元
											</td>
											<td><span id="star">*</span></td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" id="invoiceAmount" name="buySellSave.invoiceAmount" class="ui-widget-content ui-corner-all"/>&nbsp;&nbsp;kg
											</td>
											<td><span id="star">*</span></td>
										</tr>
