...
<html>
	<head>
		...
		$(function() {
			...
			$("#sellProfit").focus(function(){
				//销售利润(出厂价格) = 销售价格 - 销售成本
				if(null != sellPrice && "" != sellPrice && null != sellCost && "" != sellCost) {
					var temp = parseInt(sellPrice.value) - parseInt(sellCost.value);
					$("#sellProfit").attr("value",numFormat(temp,0));//格式化数据，保留0位小数
				}
			});
			...
			$("#submitBtn").click(function() {
				...
				if(!validateNull(sellPrice,'销售价格不能为空')) {
					return false;
				}else if(!validateNumber(sellPrice,'销售价格必须为数字')) {
					return false;
				}
				...
				document.forms[0].action = "cost/update.action";
					...
					<table width="100%" border="0" align="left" cellpadding="0"
						...
						<tr>
							...
							<td background="img/main02.png">
								<span id="maintop"></span><span class="mainAction">当前路径：修改产品核算记录</span>
							</td>
							...
							<td align="center" valign="top" bgcolor="#FEFCFC" height="500">
								...
								<table class="maintable" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
										<tr>
											...
											<td>
												<input type="text" id="materialOrigin" name="costAccounting.materialOrigin" value="<s:property value='costAccounting.materialOrigin'/>"/>
											</td>
											<td>&nbsp;</td>
											<td>日  期：</td>
											<td><input type="text" id="date" name="costAccounting.date" value="<s:property value='costAccounting.date'/>"/></td>
											<td></td>
										</tr>
										<tr>
											<td>
											...
											<td>
												<input type="text" id="materialPrice" name="costAccounting.materialPrice" value="<s:property value='costAccounting.materialPrice'/>"/>
											</td>
											<td>&nbsp;</td>
										...
										<tr>
											...
											<td>
												<input type="text" id="rateOfOil" name="costAccounting.rateOfOil" value="<s:property value='costAccounting.rateOfOil'/>"/>
											</td>
											<td>&nbsp;</td>
										...
										<tr>
											...
											<td>
												<input type="text" id="fcpz" name="costAccounting.fcpz" value="<s:property value='costAccounting.fcpz'/>"/>
											</td>
											<td>&nbsp;</td>
										...
										<tr>
											...
											<td>
												<input type="text" id="ejyJgf" name="costAccounting.ejyJgf" value="<s:property value='costAccounting.ejyJgf'/>"/>
											</td>
											<td>&nbsp;</td>
										...
										<tr>
											...
											<td>
												<input type="text" id="yjyJgf" name="costAccounting.yjyJgf" value="<s:property value='costAccounting.yjyJgf'/>"/>
											</td>
											<td>&nbsp;</td>
										...
										<tr>
											...
											<td>
												<input type="text" id="jlsh" name="costAccounting.jlsh" value="<s:property value='costAccounting.jlsh'/>"/>
											</td>
											<td>&nbsp;</td>
										...
										<tr>
											...
											<td>
												<input type="text" id="tax" name="costAccounting.tax" value="<s:property value='costAccounting.tax'/>"/>
											</td>
											<td>&nbsp;</td>
										...
										<tr>
											...
											<td>
												<input type="text" id="ttbz" name="costAccounting.ttbz" value="<s:property value='costAccounting.ttbz'/>"/>
											</td>
											<td>&nbsp;</td>
										...
										<tr>
											...
											<td>
												<input type="text" id="sellPrice" name="costAccounting.sellPrice" value="<s:property value='costAccounting.sellPrice'/>"/>
											</td>
											<td>&nbsp;</td>
										...
										<tr>
											...
											<td>
												<input type="text" id="tqyf" name="costAccounting.tqyf" value="<s:property value='costAccounting.tqyf'/>"/>
											</td>
											<td>&nbsp;</td>
											...
											<td>
												<input type="text" id="finalPrice" name="costAccounting.finalPrice" value="<s:property value='costAccounting.finalPrice'/>"/>
											</td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											...
											<td>
												<label><s:property value="costAccounting.client.name" /></label>
											</td>
											<td>&nbsp;</td>
