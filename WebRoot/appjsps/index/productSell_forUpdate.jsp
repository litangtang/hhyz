	...
	<head>
		...
		$(function() {
			...
			$("#submitBtn").click(function() {
				...
				document.forms[0].action = "productSell/update.action";
							...
							<td align="center" valign="top" bgcolor="#FEFCFC" height="500">
								...
								<table class="maintable" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
										<tr style="display: none">
											...
											<td>
												<input type="text" id="pid" name="productSell.id" value="<s:property value='productSell.id'/>" />&nbsp;
										...
										<tr style="display: none">
											...
											<td>
												<input type="text" id="year" name="productSell.year" value="<s:property value='productSell.year'/>" />&nbsp;
											</td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" id="month" name="productSell.month" value="<s:property value='productSell.month'/>" />&nbsp;
											</td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" id="day" name="productSell.day" value="<s:property value='productSell.day'/>" />&nbsp;
										...
										<tr>
											...
											<td>
												<input type="text" id="clientName" name="productSell.clientName" value="<s:property value='productSell.clientName'/>" />&nbsp;
										...
										<tr>
											...
											<td>
												<input type="text" id="packages" name="productSell.packages" value="<s:property value='productSell.packages'/>"/>&nbsp;(件)
											</td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" id="count" name="productSell.count" value="<s:property value='productSell.count'/>"/>&nbsp;(吨)
											</td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" id="price" name="productSell.price" value="<s:property value='productSell.price'/>"/>&nbsp;(元)
											</td>
											<td>&nbsp;</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" id="amount" name="productSell.amount" value="<s:property value='productSell.amount'/>"/>&nbsp;(元)
											</td>
											<td>&nbsp;</td>
										</tr>
										...
										<tr>
											...
											<td>
												<input type="text" id="remark" name="productSell.remark" value="<s:property value='productSell.remark'/>"/>&nbsp;(元)
											</td>
											<td>&nbsp;</td>
										</tr>
