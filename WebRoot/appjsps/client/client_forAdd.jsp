  ...
  <head>
		...
		$(function() {
			...
			$("#submitBtn").click(function() {
				...
				*/
				document.forms[0].action = "client/add.action";
					...
					<table width="100%" border="0" align="left" cellpadding="0"
						...
						<tr>
							...
							<td background="img/main02.png">
								...
								<s:if test=" 'client_0' == #request.from ">
									<span class="mainAction">当前路径：添加 客户</span>
								</s:if>
								<s:else>
									<span class="mainAction">当前路径：添加 - <%=(from.equals("client_1")?"原料客户":"销售客户") %></span>
								</s:else>
							</td>
							...
							<td align="center" valign="top" bgcolor="#FEFCFC" height="500">
								...
								<table class="maintable" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
										<tr>
											...
											<s:if test=" 'client_0' == #request.from ">
												<td>
													<s:select name="client.type" list="#{'1':'原料客户','2':'销售客户'}"  label="客户类型："></s:select>
												</td>
											</s:if>	
											<s:elseif test=" 'client_1' == #request.from ">
												<td>
													<label>原料客户</label>
												</td>											
											</s:elseif>
										...
										<tr>
											...
											<td>
												<input type="text" id="companyName" name="client.companyName" />
											</td>
											<td><span id="star">*</span></td>
										</tr>
										...
										<tr>
											...
											<td>
												<input type="text" id="companyAddr" name="client.companyAddr" />
											</td>
											<td>&nbsp;</td>
										</tr>
										...
										<tr>
											...
											<td>
												<input type="text" id="mobilePhone" name="client.mobilePhone" />
											</td>
											<td>&nbsp;</td>
										</tr>
										...
										<tr>
											...
											<td>
												<input type="text" id="fax" name="client.fax" />
											</td>
											<td>&nbsp;</td>
										</tr>
										...
										<tr>
											...
											<td>
												<input type="text" id="remark" name="client.remark" />
											</td>
											<td>&nbsp;</td>
										</tr>
